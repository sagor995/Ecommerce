    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="javascript:;">
                        <i class="bx bx-right-arrow-alt"></i>Manage All Order
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="javascript:;">
                        <i class="bx bx-right-arrow-alt"></i>Settings One
                    </a>
                </li>
                <li>
                    <a href="javascript:;">
                        <i class="bx bx-right-arrow-alt"></i>Settings Two
                    </a>
                </li>
                <li>
                    <a href="javascript:;">
                        <i class="bx bx-right-arrow-alt"></i>Settings Three
                    </a>
                </li>
            </ul>
        </li>
